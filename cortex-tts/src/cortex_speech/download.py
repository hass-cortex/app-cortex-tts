    ...
    def _fetch(self, spec: ModelSpec, progress: DownloadProgress) -> None:
        ...
        for source in spec.sources:
            ...
            for name in source.files:
                ...
                # Fetch into the bundle directory directly. `local_dir` copies
                # the blob out of the hub cache so /data holds exactly one copy
                # — the cache would otherwise double every model's disk cost.
                hf_hub_download(
